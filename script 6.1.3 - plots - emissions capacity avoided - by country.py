...
# First row
plot_region(fig2.add_subplot(gs2[0, 0]), df_country_chn, 'China', ylabel='GtCO2eq')
plot_region(fig2.add_subplot(gs2[0, 1]), df_country_ind, 'India')
plot_region(fig2.add_subplot(gs2[0, 2]), df_country_idn, 'Indonesia')
plot_region(fig2.add_subplot(gs2[0, 3]), df_country_zaf, 'South Africa')

# Second row
plot_region(fig2.add_subplot(gs2[1, 0]), df_country_mex, 'Mexico', ylabel='GtCO2eq')
plot_region(fig2.add_subplot(gs2[1, 1]), df_country_vnm, 'Viet Nam')
plot_region(fig2.add_subplot(gs2[1, 2]), df_country_irn, 'Iran')
plot_region(fig2.add_subplot(gs2[1, 3]), df_country_tha, 'Thailand')
...
# First row
handles += plot_combined(fig2.add_subplot(gs2[0, 0]), df_country_chn, 'China', ylabel_left='Annual (GtCO2eq)')
handles += plot_combined(fig2.add_subplot(gs2[0, 1]), df_country_ind, 'India')
handles += plot_combined(fig2.add_subplot(gs2[0, 2]), df_country_idn, 'Indonesia')
handles += plot_combined(fig2.add_subplot(gs2[0, 3]), df_country_zaf, 'South Africa', ylabel_right='Cumulative (GtCO2)')

# Second row
handles += plot_combined(fig2.add_subplot(gs2[1, 0]), df_country_mex, 'Mexico', ylabel_left='Annual (GtCO2eq)')
handles += plot_combined(fig2.add_subplot(gs2[1, 1]), df_country_vnm, 'Viet Nam')
handles += plot_combined(fig2.add_subplot(gs2[1, 2]), df_country_irn, 'Iran')
handles += plot_combined(fig2.add_subplot(gs2[1, 3]), df_country_tha, 'Thailand', ylabel_right='Cumulative (GtCO2)')
...
# First row
handles += plot_combined(fig2.add_subplot(gs2[0, 0]), df_country_chn, 'China', ylabel_left='Annual (GW)')
handles += plot_combined(fig2.add_subplot(gs2[0, 1]), df_country_ind, 'India')
handles += plot_combined(fig2.add_subplot(gs2[0, 2]), df_country_idn, 'Indonesia')
handles += plot_combined(fig2.add_subplot(gs2[0, 3]), df_country_zaf, 'South Africa', ylabel_right='Cumulative (GW)')

# Second row
handles += plot_combined(fig2.add_subplot(gs2[1, 0]), df_country_mex, 'Mexico', ylabel_left='Annual (GW)')
handles += plot_combined(fig2.add_subplot(gs2[1, 1]), df_country_vnm, 'Viet Nam')
handles += plot_combined(fig2.add_subplot(gs2[1, 2]), df_country_irn, 'Iran')
handles += plot_combined(fig2.add_subplot(gs2[1, 3]), df_country_tha, 'Thailand', ylabel_right='Cumulative (GW)')
...
# First row
ax_chn = fig.add_subplot(gs[0, 0])
plot_country_emissions(ax_chn, df_emissions_currentpolicy_chn, df_emissions_nz1550v2_chn, 'China', ylabel="GtCO2eq")
...
ax_zaf = fig.add_subplot(gs[0, 3])
plot_country_emissions(ax_zaf, df_emissions_currentpolicy_zaf, df_emissions_nz1550v2_zaf, 'South Africa')

# Second row
ax_mex = fig.add_subplot(gs[1, 0])
plot_country_emissions(ax_mex, df_emissions_currentpolicy_mex, df_emissions_nz1550v2_mex, 'Mexico', ylabel="GtCO2eq")

ax_vnm = fig.add_subplot(gs[1, 1])
plot_country_emissions(ax_vnm, df_emissions_currentpolicy_vnm, df_emissions_nz1550v2_vnm, 'Viet Nam')

ax_irn = fig.add_subplot(gs[1, 2])
plot_country_emissions(ax_irn, df_emissions_currentpolicy_irn, df_emissions_nz1550v2_irn, 'Iran')

ax_tha = fig.add_subplot(gs[1, 3])
plot_country_emissions(ax_tha, df_emissions_currentpolicy_tha, df_emissions_nz1550v2_tha, 'Thailand')
...
# First row
ax_chn = fig.add_subplot(gs[0, 0])
plot_country_avoided_emissions(ax_chn, df_byfuel_avoided_annual_chn, 'China', ylabel="GW")
...
# Second row
ax_mex = fig.add_subplot(gs[1, 0])
plot_country_avoided_emissions(ax_mex, df_byfuel_avoided_annual_mex, 'Mexico', ylabel="GW")

ax_vnm = fig.add_subplot(gs[1, 1])
plot_country_avoided_emissions(ax_vnm, df_byfuel_avoided_annual_vnm, 'Viet Nam')
...
# First row
ax_chn = fig.add_subplot(gs[0, 0])
plot_country_avoided_emissions(ax_chn, df_byfuel_avoided_cumulative_chn, 'China', ylabel="GW")
...
# Second row
ax_mex = fig.add_subplot(gs[1, 0])
plot_country_avoided_emissions(ax_mex, df_byfuel_avoided_cumulative_mex, 'Mexico', ylabel="GW")

ax_vnm = fig.add_subplot(gs[1, 1])
plot_country_avoided_emissions(ax_vnm, df_byfuel_avoided_cumulative_vnm, 'Viet Nam')
