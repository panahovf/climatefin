...
temp_country_codes = ['deu', 'idn', 'ind', 'tur', 'usa', 'vnm', 'global']
...
# --------------
# countries
df_country_deu.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/1.1 - country - DEU.xlsx', index = False)
df_country_idn.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/1.2 - country - IDN.xlsx', index = False)
df_country_ind.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/1.3 - country - IND.xlsx', index = False)
df_country_tur.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/1.4 - country - TUR.xlsx', index = False)
df_country_usa.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/1.5 - country - USA.xlsx', index = False)
df_country_vnm.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/1.6 - country - VNM.xlsx', index = False)
df_country_global.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/1.7 - country - GLOBAL.xlsx', index = False)


# --------------
# emissions  - current policy
df_emissions_currentpolicy_deu.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/2.1 - emissions - current policy - DEU.xlsx', index = False)
df_emissions_currentpolicy_idn.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/2.2 - emissions - current policy - IDN.xlsx', index = False)
df_emissions_currentpolicy_ind.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/2.3 - emissions - current policy - IND.xlsx', index = False)
df_emissions_currentpolicy_tur.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/2.4 - emissions - current policy - TUR.xlsx', index = False)
df_emissions_currentpolicy_usa.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/2.5 - emissions - current policy - USA.xlsx', index = False)
df_emissions_currentpolicy_vnm.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/2.6 - emissions - current policy - VNM.xlsx', index = False)
df_emissions_currentpolicy_global.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/2.7 - emissions - current policy - GLOBAL.xlsx', index = False)


# emissions  - netzero
df_emissions_netzero_deu.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/3.1 - emissions - netzero - DEU.xlsx', index = False)
df_emissions_netzero_idn.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/3.2 - emissions - netzero - IDN.xlsx', index = False)
df_emissions_netzero_ind.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/3.3 - emissions - netzero - IND.xlsx', index = False)
df_emissions_netzero_tur.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/3.4 - emissions - netzero - TUR.xlsx', index = False)
df_emissions_netzero_usa.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/3.5 - emissions - netzero - USA.xlsx', index = False)
df_emissions_netzero_vnm.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/3.6 - emissions - netzero - VNM.xlsx', index = False)
df_emissions_netzero_global.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/3.7 - emissions - netzero - GLOBAL.xlsx', index = False)


# emissions  - net zero 1.5C 50%
df_emissions_nz1550v2_deu.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/4.1 - emissions - net zero 15C 50% - DEU.xlsx', index = False)
df_emissions_nz1550v2_idn.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/4.2 - emissions - net zero 15C 50% - IDN.xlsx', index = False)
df_emissions_nz1550v2_ind.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/4.3 - emissions - net zero 15C 50% - IND.xlsx', index = False)
df_emissions_nz1550v2_tur.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/4.4 - emissions - net zero 15C 50% - TUR.xlsx', index = False)
df_emissions_nz1550v2_usa.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/4.5 - emissions - net zero 15C 50% - USA.xlsx', index = False)
df_emissions_nz1550v2_vnm.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/4.6 - emissions - net zero 15C 50% - VNM.xlsx', index = False)
df_emissions_nz1550v2_global.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/4.7 - emissions - net zero 15C 50% - GLOBAL.xlsx', index = False)



# --------------
# total capacity  - current policy
df_totalcapacity_currentpolicy_deu.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/5.1 - total capacity - current policy - DEU.xlsx', index = False)
df_totalcapacity_currentpolicy_idn.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/5.2 - total capacity - current policy - IDN.xlsx', index = False)
df_totalcapacity_currentpolicy_ind.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/5.3 - total capacity - current policy - IND.xlsx', index = False)
df_totalcapacity_currentpolicy_tur.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/5.4 - total capacity - current policy - TUR.xlsx', index = False)
df_totalcapacity_currentpolicy_usa.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/5.5 - total capacity - current policy - USA.xlsx', index = False)
df_totalcapacity_currentpolicy_vnm.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/5.6 - total capacity - current policy - VNM.xlsx', index = False)
df_totalcapacity_currentpolicy_global.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/5.7 - total capacity - current policy - GLOBAL.xlsx', index = False)


# emissions  - netzero
df_totalcapacity_netzero_deu.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/6.1 - total capacity - netzero - DEU.xlsx', index = False)
df_totalcapacity_netzero_idn.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/6.2 - total capacity - netzero - IDN.xlsx', index = False)
df_totalcapacity_netzero_ind.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/6.3 - total capacity - netzero - IND.xlsx', index = False)
df_totalcapacity_netzero_tur.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/6.4 - total capacity - netzero - TUR.xlsx', index = False)
df_totalcapacity_netzero_usa.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/6.5 - total capacity - netzero - USA.xlsx', index = False)
df_totalcapacity_netzero_vnm.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/6.6 - total capacity - netzero - VNM.xlsx', index = False)
df_totalcapacity_netzero_global.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/6.7 - total capacity - netzero - GLOBAL.xlsx', index = False)


# emissions  - net zero 1.5C 50%
df_totalcapacity_nz1550v2_deu.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/7.1 - total capacity - net zero 15C 50% - DEU.xlsx', index = False)
df_totalcapacity_nz1550v2_idn.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/7.2 - total capacity - net zero 15C 50% - IDN.xlsx', index = False)
df_totalcapacity_nz1550v2_ind.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/7.3 - total capacity - net zero 15C 50% - IND.xlsx', index = False)
df_totalcapacity_nz1550v2_tur.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/7.4 - total capacity - net zero 15C 50% - TUR.xlsx', index = False)
df_totalcapacity_nz1550v2_usa.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/7.5 - total capacity - net zero 15C 50% - USA.xlsx', index = False)
df_totalcapacity_nz1550v2_vnm.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/7.6 - total capacity - net zero 15C 50% - VNM.xlsx', index = False)
df_totalcapacity_nz1550v2_global.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/7.7 - total capacity - net zero 15C 50% - GLOBAL.xlsx', index = False)



# --------------
# by fuel --- annual avoided
df_byfuel_avoided_annual_deu.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/8.1 - avoided capacity - annual - DEU.xlsx', index = False)
df_byfuel_avoided_annual_idn.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/8.2 - avoided capacity - annual - IDN.xlsx', index = False)
df_byfuel_avoided_annual_ind.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/8.3 - avoided capacity - annual - IND.xlsx', index = False)
df_byfuel_avoided_annual_tur.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/8.4 - avoided capacity - annual - TUR.xlsx', index = False)
df_byfuel_avoided_annual_usa.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/8.5 - avoided capacity - annual - USA.xlsx', index = False)
df_byfuel_avoided_annual_vnm.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/8.6 - avoided capacity - annual - VNM.xlsx', index = False)
df_byfuel_avoided_annual_global.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/8.7 - avoided capacity - annual - GLOBAL.xlsx', index = False)


# by fuel --- cumulative avoided
df_byfuel_avoided_cumulative_deu.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/9.1 - avoided capacity - cumulative - DEU.xlsx', index = False)
df_byfuel_avoided_cumulative_idn.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/9.2 - avoided capacity - cumulative - IDN.xlsx', index = False)
df_byfuel_avoided_cumulative_ind.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/9.3 - avoided capacity - cumulative - IND.xlsx', index = False)
df_byfuel_avoided_cumulative_tur.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/9.4 - avoided capacity - cumulative - TUR.xlsx', index = False)
df_byfuel_avoided_cumulative_usa.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/9.5 - avoided capacity - cumulative - USA.xlsx', index = False)
df_byfuel_avoided_cumulative_vnm.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/9.6 - avoided capacity - cumulative - VNM.xlsx', index = False)
df_byfuel_avoided_cumulative_global.to_excel('2 - output/6.1 - Power sector - By country - Emissions & Capacity - Annual Cumulative Avoided/9.7 - avoided capacity - cumulative - GLOBAL.xlsx', index = False)
